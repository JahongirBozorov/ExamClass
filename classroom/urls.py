...
router.register(r'teacher', views.TeacherVieSet)
router.register(r'studentMarks', views.StudentMarksViewSet)
router.register(r'studentclass', views.StudentsInClassViewSet)
router.register(r'classassignment', views.ClassAssignmentViewSet)
router.register(r'submitassignment', views.SubmitAssignmentViewSet)
